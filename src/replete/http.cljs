...
(def ^:private ^:const boundary-constant "---------------replete-rocks-")
...
(defn get
  ...
  ([url] (get url {}))
  ([url opts] (request js/REPLETE_REQUEST :get url opts)))
...
(defn head
  ...
  :socket, string, specifying a system path to a socket to use"
  ([url] (head url {}))
  ([url opts] (request js/REPLETE_REQUEST :head url opts)))
...
(defn delete
  ...
  :socket, string, specifying a system path to a socket to use"
  ([url] (delete url {}))
  ([url opts] (request js/REPLETE_REQUEST :delete url opts)))
...
(defn post
  ...
  ([url] (post url {}))
  ([url opts] (request js/REPLETE_REQUEST :post url opts)))
...
(defn put
  ...
  :multipart-params, a list of tuples, used for file-upload
                     {:multipart-params [[\"name\" \"value\"]
                                         [\"name\" [\"content\" \"filename\"]]"
  ([url] (put url {}))
  ([url opts] (request js/REPLETE_REQUEST :put url opts)))
...
(defn patch
  ...
  :multipart-params, a list of tuples, used for file-upload
                     {:multipart-params [[\"name\" \"value\"]
                                         [\"name\" [\"content\" \"filename\"]]"
  ([url] (patch url {}))
  ([url opts] (request js/REPLETE_REQUEST :patch url opts)))
